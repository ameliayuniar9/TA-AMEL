...
<!--                <div class="category-nav show-on-click">
    ...
    <!--<div class="col-md-3 col-sm-6 col-xs-6">-->
            ...
            <h3 align="center">UBAH DATA AKUN</h3>
            <form:form id="akunUpdate" action="updateDataAkun.htm" modelAttribute="akunDto" method="POST">
            <form:hidden path="kode_akun" name="kode_akun" value="${akunDto.kode_akun}" />
            <center><table>
                    <tr>
                        <td>NAMA AKUN</td>
                        <td>&nbsp;&nbsp;</td>
                        <td><div class="form-group">
                                <form:input class="input" path="nama_akun" name="nama_akun"  value="${akunDto.nama_akun}"/>
                            </div></td>
                    </tr>
                    <tr>
                        <td>DESKRIPSI</td>
                        <td>&nbsp;&nbsp;</td>
                        <td><div class="form-group">
                                <form:input class="input" path="deskripsi" name="deskripsi" value="${akunDto.deskripsi}"/>
                            </div></td>
                    </tr>
                    <tr>
                        <td></td>
