...
<!--                <div class="category-nav show-on-click">
    ...
    <!--<div class="col-md-3 col-sm-6 col-xs-6">-->
             ...
             <h3 align="center">UBAH DATA ULASAN</h3>
            <form:form id="ulasanUpdate" action="updateUlasan.htm" modelAttribute="ulasanDto" method="POST" enctype="multipart/form-data">
                 <form:hidden path="kode_ulasan" value="${ulasanDto.kode_ulasan}" />
            <center><table>
                    <tr>
                        <td>VIDEO</td>
                        <td>&nbsp;&nbsp;</td>
                     ...
                     <tr>
                        ...
                        <td>&nbsp;&nbsp;</td>
                        <td><div class="form-group">
                                <form:input path="keterangan" class="input" value="${ulasanDto.keterangan}"/>
                            </div></td>
                    </tr>
                    <tr>
                    <tr>
