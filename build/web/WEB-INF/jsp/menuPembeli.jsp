<%-- 
    Document   : menuPembeli
    Created on : Jul 26, 2019, 2:45:15 PM
    Author     : HP
--%>
...
<html lang="en">
    ...
    <body>
                                        ...
                                        <div class="shopping-cart-list">
                                            <div class="product product-widget">
                                                ...
                                                <div class="product-body">
                                                    ...
                                                    <h2 class="product-name"><a href="#">AMELIA YUNIAR</a></h2>
                                                </div>
                ...
                <div id="responsive-nav">
                                    ...
                                    <div class="row hidden-sm hidden-xs">
                                        <div class="col-md-12">
                                            ...
                                            <a class="banner banner-1" href="#">
                                                <img src="./a/img/banner05.jpg" alt="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 hidden-sm hidden-xs">
                                            <a class="banner banner-2" href="#">
                                                <img src="./a/img/banner04.jpg" alt="">
                    ...
                    <div class="menu-nav">
                        ...
                        <ul class="menu-list">
                            ...
                            <li><a href="products.html">Data Produk</a></li>
                            <li><a href="product-page.html">Data Penjualan</a></li>
                            <li><a href="products.html">Data Pembayaran</a></li>
        ...
        <div class="section">
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-6">
                                        <div class="product product-single">
                                            <div class="product-thumb">
                                                ...
                                                <img src="./a/img/product03.jpg" alt="">
                                            </div>
                                            <c:forEach var="listProduk" items="${listProdukDto}">
                                            <div class="product-body">
                                                <h3 class="product-price">${listProduk.harga_jual}</h3>
                                                <div class="product-rating">
                                                    <i class="fa fa-star"></i>
                                                    <i class="fa fa-star"></i>
                                                    <i class="fa fa-star"></i>
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-6">
                                        <div class="product product-single">
                                            <div class="product-thumb">
                                                <button class="main-btn quick-view"><i class="fa fa-search-plus"></i> Quick view</button>
                                                <img src="./a/img/product02.jpg" alt="">
                                            </div>
                                            <div class="product-body">
                                                <h3 class="product-price">$32.50</h3>
                                                <div class="product-rating">
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-6">
                                        <div class="product product-single">
                                            <div class="product-thumb">
                                                ...
                                                <button class="main-btn quick-view"><i class="fa fa-search-plus"></i> Quick view</button>
                                                <img src="./a/img/product04.jpg" alt="">
                                            </div>
                                            <div class="product-body">
                                                <h3 class="product-price">$32.50</h3>
                                                <div class="product-rating">
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-6">
                                        <div class="product product-single">
                                            <div class="product-thumb">
                                                ...
                                                <button class="main-btn quick-view"><i class="fa fa-search-plus"></i> Quick view</button>
                                                <img src="./a/img/product05.jpg" alt="">
                                            </div>
                                            <div class="product-body">
                                                <h3 class="product-price">$32.50</h3>
                                                <div class="product-rating">
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-6">
                                        <div class="product product-single">
                                            <div class="product-thumb">
                                                ...
                                                <button class="main-btn quick-view"><i class="fa fa-search-plus"></i> Quick view</button>
                                                <img src="./a/img/product06.jpg" alt="">
                                            </div>
                                            <div class="product-body">
                                                <h3 class="product-price">$32.50 <del class="product-old-price">$45.00</del></h3>
                                                <div class="product-rating">
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-6">
                                        <div class="product product-single">
                                            <div class="product-thumb">
                                                ...
                                                <button class="main-btn quick-view"><i class="fa fa-search-plus"></i> Quick view</button>
                                                <img src="./a/img/product07.jpg" alt="">
                                            </div>
                                            <div class="product-body">
                                                <h3 class="product-price">$32.50 <del class="product-old-price">$45.00</del></h3>
                                                <div class="product-rating">
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-6">
                                        <div class="product product-single">
                                            <div class="product-thumb">
                                                <button class="main-btn quick-view"><i class="fa fa-search-plus"></i> Quick view</button>
                                                <img src="./a/img/product08.jpg" alt="">
                                            </div>
                                            <div class="product-body">
                                                <h3 class="product-price">$32.50</h3>
                                                <div class="product-rating">
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-6">
                                        <div class="product product-single">
                                            <div class="product-thumb">
                                                ...
                                                <button class="main-btn quick-view"><i class="fa fa-search-plus"></i> Quick view</button>
                                                <img src="./a/img/product01.jpg" alt="">
                                            </div>
                                            <div class="product-body">
                                                <h3 class="product-price">$32.50 <del class="product-old-price">$45.00</del></h3>
                                                <div class="product-rating">
            ...
            <script src="a/js/nouislider.min.js"></script>
            <script src="a/js/jquery.zoom.min.js"></script>
