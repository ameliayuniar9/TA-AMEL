...
<!--                <div class="category-nav show-on-click">
    ...
    <!--<div class="col-md-3 col-sm-6 col-xs-6">-->
            ...
            <h3 align="center">TAMBAH DATA AKUN</h3>
            <form:form id="akun" action="saveDataAkun.htm" modelAttribute="akunDto" method="POST">
            <center><table>
                    <tr>
                        <td>NAMA AKUN</td>
                        <td>&nbsp;&nbsp;</td>
                        <td><div class="form-group">
                                <form:input path="nama_akun" class="input"/>
                            </div></td>
                    </tr>
                    <tr>
                        <td>DESKRIPSI</td>
                        <td>&nbsp;&nbsp;</td>
                        <td><div class="form-group">
                                <form:input path="deskripsi" class="input"/>
                            </div></td>
                    </tr>
                    <tr>
                        <td></td>
