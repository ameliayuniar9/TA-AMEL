            ...
            <div class="container">
                <div class="row p-b-148">
                    <div class="col-md-7 col-lg-8">
                        <div class="p-t-7 p-r-85 p-r-15-lg p-r-0-md">
                            ...
                            <p class="stext-113 cl6 p-b-26">
                                Toko online hijab istmostly berdiri pada tanggal 4 Juni 2018 yang didirikan oleh Jennie Sakina yang masih berusia sangat muda. Toko ini beralamat di Gang H Hambali 1 No 93B Kecamatan Cicendo Kota Bandung.
                            </p>

                            <p class="stext-113 cl6 p-b-26">
                                Melihat pada zaman sekarang ini banyak orang yang menggunakan hijab jumlahnya pun  setiap tahun meningkat. Melihat hal ini secara tidak langsung dapat memberikan peluang bisnis. Dengan pemikiran inilah maka Jennie memutuskan untuk mulai merintis usaha ini dengan menggunakan instagram sebagai media penjualan. 
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-11 col-md-5 col-lg-4 m-lr-auto">
                        <div class="how-bor1 ">
                            <div class="hov-img0">
                                <img src="b/images/tim1.PNG" alt="IMG">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="order-md-2 col-md-7 col-lg-8 p-b-30">
                        <div class="p-t-7 p-l-85 p-l-15-lg p-l-0-md">
                            ...
                            <p class="stext-113 cl6 p-b-26">
                                <b>1. Visi</b>
                                <br>&nbsp;&nbsp;&nbsp;&nbsp;Membangun perusahaan online yang sukses dan bermanfaat bagmasyarakat.
                                <br><br><b>2. Misi</b>

                                <br>&nbsp;&nbsp;&nbsp;a. Meningkatkan minat kaum hawa untuk berhijab dengan menjual hijab yang mudah digunakan
                                <br>&nbsp;&nbsp;&nbsp;b. Memberikan pelayanan yang terbaik</li>
                                <br>&nbsp;&nbsp;&nbsp;c. Mengurangi pengangguran dan melatihnya menjadi multitalenta
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="order-md-1 col-11 col-md-5 col-lg-4 m-lr-auto p-b-30">
                        <div class="how-bor2">
                            <div class="hov-img0">
                                <img src="b/images/tim2.jpeg" alt="IMG">
                            </div>
                        </div>
                    </div>
                </div>
