...
<!--                <div class="category-nav show-on-click">
    ...
    <!--<div class="col-md-3 col-sm-6 col-xs-6">-->
            ...
            <h3 align="center">TAMBAH DETAIL PRODUK</h3>
           <form:form id="detail" action="saveDetail.htm" modelAttribute="detailDto" method="POST" enctype="multipart/form-data">
            <center><table>
                    <tr>
                        <td>PRODUK</td>
                        <td></td>
                        <td><div class="form-group">
                            <form:select path="kode_produk" class="input">
                    ...
                    <tr>
                        ...
                        <td>&nbsp;&nbsp;</td>
                        <td><div class="form-group">
                                <form:input path="warna" class="validate validate[required,maxSize[100],custom[onlyLetter]]"/>
                            </div></td>
                    </tr>
                    <tr>
                        <td>GAMBAR</td>
                    ...
                    <tr>
                        ...
                        <td>&nbsp;&nbsp;</td>
                        <td><div class="form-group">
                                <form:input path="stok" class="validate validate[required,custom[onlyNumberSp],maxSize[14],custom[noSpace]]"/>
                            </div></td>
                    </tr>
                    <tr>
                        <td></td>
                        ...
                        function () {
                            $("#save").click(
                                    function (evt) { //id tombol submit
                                        evt.preventDefault();
                                        var validate = $('#detail').validationEngine('validate'); //id form
                                        if (validate) {
                                            $('#detail').submit();
                                        } else {
                                            return false;
