...
<html>
    <head>
        ...
        <title>Ubah Tabel Kategori</title>
    ...
    <body>
        ...
        <h3 align="center">UBAH DATA KATEGORI</h3>
        <form:form id="kategoriUpdate" action="updateKategori.htm" modelAttribute="kategoriDto" method="POST">
            <form:hidden path="kode_kategori" value="${kategoriDto.kode_kategori}" />
        <center><table>
                <tr>
                    <td>NAMA KATEGORI</td>
                    <td>&nbsp;&nbsp;</td>
                    <td><div class="form-group">
                            <form:input path="nama_kategori" class="validate validate[required,maxSize[100],custom[onlyLetter]]" value="${kategoriDto.nama_kategori}"/>
                        </div></td>
                </tr>
                <tr>
                    <td></td>
                        ...
                        function () {
                            $("#save").click(
                                    function (evt) { //id tombol submit
                                        evt.preventDefault();
                                        var validate = $('#kategoriUpdate').validationEngine('validate'); //id form
                                        if (validate) {
                                            $('#kategoriUpdate').submit();
                                        } else {
                                            return false;
                                        }
                                    }
