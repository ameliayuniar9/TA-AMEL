...
<!--                <div class="category-nav show-on-click">
    ...
    <!--<div class="col-md-3 col-sm-6 col-xs-6">-->
            ...
            <h3 align="center">UBAH DETAIL PRODUK</h3>
            <form:form id="detailUpdate" action="updateDetail.htm" modelAttribute="detailDto" method="POST" enctype="multipart/form-data">
                 <form:hidden path="kode_detail" value="${detailDto.kode_detail}" />
            <center><table>
                    <tr>
                        <td>PRODUK</td>
                        <td></td>
                        <td><div class="form-group">
                            <form:select path="kode_produk" class="input" value="${detailDto.kode_produk}">
                            <form:option value="" selected="true" disabled="true">Pilih Produk</form:option>
                            <c:forEach var="prod" items="${listProd}">
                                <form:option value="${prod.kode_produk}">${prod.nama_produk}</form:option>
                            </c:forEach>
                            </form:select></div></td>
                    </tr>
                    <tr>
                        ...
                        <td>&nbsp;&nbsp;</td>
                        <td><div class="form-group">
                                <form:input path="warna" class="validate validate[required,maxSize[100],custom[onlyLetter]]" value="${detailDto.warna}"/>
                            </div></td>
                    </tr>
                    <tr>
                        <td>GAMBAR</td>
                        <td>&nbsp;&nbsp;</td>
                        <td><div class="form-group">
                                <form:input type="file" path="file" id="txfile" value="${detailDto.gambar}"/>
                            </div></td>
                    </tr>
                    <tr>
                        <td>STOK</td>
                        <td>&nbsp;&nbsp;</td>
                        <td><div class="form-group">
                                <form:input path="stok" class="validate validate[required,custom[onlyNumberSp],maxSize[14],custom[noSpace]]" value="${detailDto.stok}"/>
                            </div></td>
                    </tr>
                    <tr>
                        <td></td>
                        ...
                        function () {
                            $("#save").click(
                                    function (evt) { //id tombol submit
                                        evt.preventDefault();
                                        var validate = $('#detailUpdate').validationEngine('validate'); //id form
                                        if (validate) {
                                            $('#detailUpdate').submit();
                                        } else {
                                            return false;
