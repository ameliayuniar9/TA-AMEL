...
<head>
    ...
    <title>Tambah Data Ongkir</title>
...
<!--                <div class="category-nav show-on-click">
    ...
    <!--<div class="col-md-3 col-sm-6 col-xs-6">-->
            ...
            <h3 align="center">TAMBAH DATA ONGKIR</h3>
            <form:form id="ongkir" action="saveOngkir.htm" modelAttribute="ongkirDto" method="POST">
            <center><table>
                    <tr>
                        <td>NAMA KOTA</td>
                        <td>&nbsp;&nbsp;</td>
                        <td><div class="form-group">
                                <form:input path="nama_kota" class="validate validate[required,maxSize[100],custom[onlyLetter]]"/>
                            </div></td>
                    </tr>
                    <tr>
                        <td>ONGKIR</td>
                        <td>&nbsp;&nbsp;</td>
                        <td><div class="form-group">
                                <form:input path="harga" class="validate validate[required,custom[onlyNumberSp],maxSize[14],custom[noSpace]]"/>
                            </div></td>
                    </tr>
                    <tr>
                        <td></td>
                        ...
                        function () {
                            $("#save").click(
                                    function (evt) { //id tombol submit
                                        evt.preventDefault();
                                        var validate = $('#ongkir').validationEngine('validate'); //id form
                                        if (validate) {
                                            $('#ongkir').submit();
                                        } else {
                                            return false;
