...
<body>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <h5 align="center">Tabel Permintaan Pengeluaran</h5>
            ...
            <c:choose>
                <c:when test="${listPengeluaran.status=='Disapprove'}">
                    <tr>  
                        ...
                        <td style="background: red">${listPengeluaran.tanggal}</td>
                        <td style="background: red">${listPengeluaran.nama_akun}</td>
                        <td style="background: red">${listPengeluaran.deskripsi}</td>
                        <td style="background: red">${listPengeluaran.jumlah}</td>
                        <td style="background: red">
                            <a class="image-popup-vertical-fit" href="b/img/bukti pengeluaran/${listPengeluaran.upload_file}" >  <img src="b/img/bukti pengeluaran/${listPengeluaran.upload_file}" style="height: 50px; width: 75px"/></a></td>
                        ...
                        <td style="background: red;" align="center"  ><a class="btn btn-danger" href="${deletePengeluaran}">Hapus</a></td>
                    </tr>   
                </c:when>
                <c:otherwise>
                    <tr>  
                        ...
                        <td align="center"><a class="btn btn-warning" href="${deletePengeluaran}">Batal</a>
                        </td>
                    </tr>   
                </c:otherwise>
            </c:choose>
