...
<!--                <div class="category-nav show-on-click">
    ...
    <!--<div class="col-md-3 col-sm-6 col-xs-6">-->
             ...
             <h3 align="center">UBAH DATA ONGKIR</h3>
            <form:form id="ongkirUpdate" action="updateOngkir.htm" modelAttribute="ongkirDto" method="POST">
                 <form:hidden path="kode_ongkir" value="${ongkirDto.kode_ongkir}" />
            <center><table>
                    <tr>
                        <td>NAMA KOTA</td>
                        <td>&nbsp;&nbsp;</td>
